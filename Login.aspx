<%@ Page Title="" Language="C#" MasterPageFile="~/Authentication.master" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="_Default" %>
                ...
                <td>
                    <center>
                        ...
                        <asp:UpdatePanel ID="pnlData" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:Button ID="btnSubmit" runat="server" Text="Signin" OnClick="btn_login" />
                            </ContentTemplate>
                        </asp:UpdatePanel></center>
   
    New User&nbsp; <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/User_Registration.aspx">Signup here</asp:HyperLink></td></tr>
    </table> 
</asp:Content>
